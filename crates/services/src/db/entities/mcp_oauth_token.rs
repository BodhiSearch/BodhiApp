...
pub enum Relation {
  #[sea_orm(
    belongs_to = "super::mcp_oauth_config::Entity",
    from = "Column::McpOauthConfigId",
    to = "super::mcp_oauth_config::Column::Id"
  )]
  McpOAuthConfig,
}
...
impl From<McpOAuthTokenView> for objs::McpOAuthToken {
...
impl From<Model> for crate::db::McpOAuthTokenRow {
  fn from(m: Model) -> Self {
    crate::db::McpOAuthTokenRow {
      id: m.id,
