...
ai_api_service-api_error = received API error from remote api model: {$var_0}
ai_api_service-unauthorized = received Unauthorized access error from remote api model: {$var_0}
ai_api_service-not_found = received Not Found error from remote api model: {$var_0}
ai_api_service-rate_limit = received Rate Limit from remote api model: {$var_0}
ai_api_service-prompt_too_long = test prompt is longer than allowed length, allowed: {$max_length}, actual: {$actual_length}
ai_api_service-model_not_found = model not found in remote api: {$var_0}
