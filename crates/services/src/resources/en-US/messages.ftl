...
ai_api_service_error-api_error = received API error from remote api model: {$var_0}
ai_api_service_error-unauthorized = received Unauthorized access error from remote api model: {$var_0}
ai_api_service_error-not_found = received Not Found error from remote api model: {$var_0}
