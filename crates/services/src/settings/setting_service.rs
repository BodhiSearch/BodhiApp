...
use super::{
  ...
  BODHI_LOGS, BODHI_LOG_LEVEL, BODHI_ON_RUNPOD, BODHI_PORT, BODHI_PUBLIC_HOST, BODHI_PUBLIC_PORT,
...
pub trait SettingService: std::fmt::Debug + Send + Sync {
  ...
  async fn app_db_url(&self) -> String {
    self
      .get_setting(BODHI_APP_DB_URL)
      .await
...
#[cfg(test)]
#[path = "test_setting_service.rs"]
mod test_setting_service;

#[cfg(test)]
#[path = "test_setting_service_db.rs"]
mod test_setting_service_db;
