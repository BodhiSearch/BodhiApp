...
use super::{
  ...
  BODHI_PORT, BODHI_PUBLIC_HOST, BODHI_PUBLIC_PORT, BODHI_PUBLIC_SCHEME,
  BODHI_PUBLIC_URL_REACHABLE, BODHI_REFERENCE_API_URL, BODHI_SCHEME, BODHI_SESSION_DB_URL,
  BODHI_TUNNEL, BODHI_TUNNEL_AUTO_RECONNECT, DEFAULT_CANONICAL_REDIRECT, DEFAULT_HOST,
  DEFAULT_KEEP_ALIVE_SECS, DEFAULT_LOG_LEVEL, DEFAULT_LOG_STDOUT, DEFAULT_PORT,
  DEFAULT_PUBLIC_URL_REACHABLE, DEFAULT_REFERENCE_API_URL_DEV, DEFAULT_REFERENCE_API_URL_PROD,
  DEFAULT_SCHEME, HF_HOME, LOGS_DIR, PROD_DB, SESSION_DB, SETTING_VARS,
};
...
fn build_all_defaults(
  ...
  ensure_default!(
    BODHI_PUBLIC_URL_REACHABLE,
    Value::Bool(DEFAULT_PUBLIC_URL_REACHABLE)
  );
