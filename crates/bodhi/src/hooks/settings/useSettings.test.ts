import { BodhiErrorResponse, SettingInfo } from '@bodhiapp/ts-client';
import { act, renderHook, waitFor } from '@testing-library/react';
import { AxiosError } from 'axios';
import { beforeAll, describe, expect, it } from 'vitest';

import { useListSettings, useUpdateSetting, useDeleteSetting } from '@/hooks/settings';
...
describe('Settings Hooks', () => {
  describe('useListSettings', () => {
    it('fetches settings successfully', async () => {
      const { result } = renderHook(() => useListSettings(), {
