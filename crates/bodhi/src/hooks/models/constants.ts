...
export const ENDPOINT_MODEL_FILES_PULL_ARCHIVE = `${BODHI_API_BASE}/models/files/pull/{id}/archive`;
export const ENDPOINT_MODEL_FILES_PULL_RETRY = `${BODHI_API_BASE}/models/files/pull/{id}/retry`;
