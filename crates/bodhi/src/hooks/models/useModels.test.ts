...
describe('Model Hooks', () => {
  describe('useListModelFiles', () => {
    ...
    it('fetches model files with custom pagination and sorting', async () => {
      ...
      const { result } = renderHook(() => useListModelFiles(2, 10, 'filename', 'desc'), {
        wrapper: createWrapper(),
      });
  ...
  describe('useListModels', () => {
    ...
    it('fetches models successfully', async () => {
      const { result } = renderHook(() => useListModels(1, 30, 'alias', 'asc'), {
        wrapper: createWrapper(),
      });
    ...
    it('fetches models with custom pagination', async () => {
      ...
      const { result } = renderHook(() => useListModels(2, 10, 'repo', 'desc'), {
        wrapper: createWrapper(),
      });
  ...
  describe('useGetModel', () => {
    ...
    it('fetches individual model successfully', async () => {
      const { result } = renderHook(() => useGetModel(id), {
        wrapper: createWrapper(),
      });
    ...
    it('handles model not found error', async () => {
      ...
      const { result } = renderHook(() => useGetModel(notFoundId), {
        wrapper: createWrapper(),
      });
  ...
  describe('useListDownloads', () => {
    ...
    it('fetches downloads with custom pagination', async () => {
      ...
      const { result } = renderHook(() => useListDownloads(2, 10), {
        wrapper: createWrapper(),
      });
    ...
    it('enables polling when specified', async () => {
      const { result } = renderHook(() => useListDownloads(1, 30, { enablePolling: true }), {
        wrapper: createWrapper(),
      });
