...
import { ENDPOINT_OAI_CHAT_COMPLETIONS } from './constants';
...
export function useChatCompletion() {
  const appendMutation = useMutation<
    ...
    AxiosError,
    {
      ...
      RequestExts
  >({
    mutationFn: async ({ request, headers, signal, onDelta, onToolCallDelta, onMessage, onFinish, onError }) => {
      const baseUrl =
  ...
  return {
    ...
    isLoading: appendMutation.isPending,
