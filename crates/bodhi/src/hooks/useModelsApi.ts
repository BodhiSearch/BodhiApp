...
// API endpoints
export const ENDPOINT_API_MODELS = '/bodhi/v1/models/api';
export const ENDPOINT_API_MODEL_ID = '/bodhi/v1/models/api/{id}';
export const ENDPOINT_API_MODELS_TEST = '/bodhi/v1/models/api/test';
export const ENDPOINT_API_MODELS_FETCH = '/bodhi/v1/models/api/fetch-models';
export const ENDPOINT_API_MODELS_FORMATS = '/bodhi/v1/models/api/formats';
/**
 * Hook to fetch a single API model by id
 */
export function useApiModel(
  id: string,
  options?: UseQueryOptions<ApiAliasResponse, AxiosError<ErrorResponse>>
): UseQueryResult<ApiAliasResponse, AxiosError<ErrorResponse>> {
  return useQuery<ApiAliasResponse>(['api-models', id], `${ENDPOINT_API_MODELS}/${id}`, undefined, {
    enabled: !!id,
...
export function useCreateApiModel(
  ...
  return useMutationQuery<ApiAliasResponse, ApiModelRequest>(
    ENDPOINT_API_MODELS,
    'post',
    {
      ...options,
