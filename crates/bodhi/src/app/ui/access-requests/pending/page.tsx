...
function PendingRequestRow({ request, userRole }: { request: UserAccessRequestDto; userRole: string }) {
...
function PendingRequestsContent() {
  ...
  const renderRow = (request: UserAccessRequestDto) => <PendingRequestRow request={request} userRole={userRole} />;
