...
it.skip('MemoizedReactMarkdown', () => {
  ...
  testFiles.forEach(({ file }) => {
    it(`renders ${file} markdown correctly in block mode`, async () => {
      ...
      const { container } = render(
        <MemoizedReactMarkdown className="markdown-body" remarkPlugins={[remarkGfm]}>
          {input}
  ...
  it('memoizes correctly with same props', () => {
    ...
    const { rerender, container } = render(
      <MemoizedReactMarkdown className={className}>{content}</MemoizedReactMarkdown>
    );
  ...
  it('re-renders when content changes', () => {
    ...
    const { rerender, container } = render(
      <MemoizedReactMarkdown className={className}>{initialContent}</MemoizedReactMarkdown>
    );
