import { getAllDocSlugs, getDocDetails, getDocsForSlug } from '@/components/docs/utils';
import fs from 'fs';
...
const EMPTY_TEST_DOCS_DIR = path.join('src', 'components', 'docs', '__tests__', 'empty-test-docs');
