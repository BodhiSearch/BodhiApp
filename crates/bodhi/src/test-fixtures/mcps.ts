...
export function createMockMcp(overrides?: Partial<Mcp>): Mcp {
  return {
    ...
    description: 'An example MCP server',
    enabled: true,
    path: '/bodhi/v1/apps/mcps/mcp-uuid-1/mcp',
    auth_type: 'public',
    created_at: '2024-01-01T00:00:00Z',
    updated_at: '2024-01-01T00:00:00Z',
    ...overrides,
...
export function createMockMcpWithHeaderAuth(overrides?: Partial<Mcp>): Mcp {
  return createMockMcp({
    ...
    path: '/bodhi/v1/apps/mcps/mcp-uuid-2/mcp',
    auth_type: 'header',
...
export function createMockMcpWithOAuth(overrides?: Partial<Mcp>): Mcp {
  return createMockMcp({
    ...
    slug: 'oauth-mcp',
    name: 'OAuth MCP',
    path: '/bodhi/v1/apps/mcps/mcp-uuid-3/mcp',
    auth_type: 'oauth',
...
export function createMockMcpWithDcr(overrides?: Partial<Mcp>): Mcp {
  return createMockMcp({
    ...
    slug: 'dcr-mcp',
    name: 'DCR MCP',
    path: '/bodhi/v1/apps/mcps/mcp-uuid-4/mcp',
    auth_type: 'oauth',
