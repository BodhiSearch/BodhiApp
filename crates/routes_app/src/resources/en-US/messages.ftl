...
login_error-o_auth_error = OAuth authentication failed: {$var_0}
...
login_error-state_digest_mismatch = state parameter in callback does not match with the one sent in login request
...
settings_error-unsupported = updating setting {$var_0} is not supported yet
