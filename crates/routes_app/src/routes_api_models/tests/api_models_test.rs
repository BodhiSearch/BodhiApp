...
// Auth tier: PowerUser - These endpoints require PowerUser role or above for full access
// Safe endpoints: GET /bodhi/v1/api-models (list), GET /bodhi/v1/api-models/api-formats (list formats)
// These are read-only operations that don't modify state or expose sensitive credentials
