...
#[anyhow_trace]
#[rstest]
#[case::list_downloads("GET", "/bodhi/v1/models/files/pull")]
#[case::create_pull_request("POST", "/bodhi/v1/models/files/pull")]
#[case::get_download_status("GET", "/bodhi/v1/models/files/pull/some-id")]
#[tokio::test]
...
async fn test_pull_endpoints_reject_insufficient_role(
  ...
  #[values(
    ("GET", "/bodhi/v1/models/files/pull"),
    ("POST", "/bodhi/v1/models/files/pull"),
    ("GET", "/bodhi/v1/models/files/pull/some-id")
  )]
  endpoint: (&str, &str),
) -> anyhow::Result<()> {
