...
#[case::list_modelfiles("GET", "/bodhi/v1/models/files")]
#[tokio::test]
...
#[anyhow_trace]
#[rstest]
#[case::create_model("POST", "/bodhi/v1/models/alias")]
#[case::update_model("PUT", "/bodhi/v1/models/alias/some-id")]
#[case::delete_model("DELETE", "/bodhi/v1/models/alias/some-id")]
#[case::copy_model("POST", "/bodhi/v1/models/alias/some-id/copy")]
#[tokio::test]
...
async fn test_write_endpoints_reject_user_role(
  #[values(
    ("POST", "/bodhi/v1/models/alias"),
    ("PUT", "/bodhi/v1/models/alias/some-id"),
    ("DELETE", "/bodhi/v1/models/alias/some-id"),
    ("POST", "/bodhi/v1/models/alias/some-id/copy")
  )]
  endpoint: (&str, &str),
) -> anyhow::Result<()> {
  use crate::test_utils::{build_test_router, create_authenticated_session, session_request};
