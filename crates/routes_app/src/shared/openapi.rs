...
use crate::{
  ...
  McpAuth, McpExecuteRequest, McpExecuteResponse, McpResponse, McpServerResponse, McpToolsResponse,
  OAuthConfigResponse, OAuthConfigsListResponse, OAuthDiscoverRequest, OAuthDiscoverResponse,
  OAuthLoginRequest, OAuthLoginResponse, OAuthTokenExchangeRequest, OAuthTokenResponse,
  UpdateAuthHeaderRequest, UpdateMcpRequest, UpdateMcpServerRequest,
  __path_create_auth_header_handler, __path_create_mcp_handler, __path_create_mcp_server_handler,
  __path_create_oauth_config_handler, __path_delete_auth_header_handler, __path_delete_mcp_handler,
  __path_delete_oauth_token_handler, __path_execute_mcp_tool_handler,
  __path_fetch_mcp_tools_handler, __path_get_auth_header_handler, __path_get_mcp_handler,
  __path_get_mcp_server_handler, __path_get_oauth_config_handler, __path_get_oauth_token_handler,
  __path_list_mcp_servers_handler, __path_list_mcps_handler, __path_list_oauth_configs_handler,
  __path_oauth_discover_handler, __path_oauth_login_handler, __path_oauth_token_exchange_handler,
  __path_refresh_mcp_tools_handler, __path_update_auth_header_handler, __path_update_mcp_handler,
...
use objs::{
  Alias, ApiFormat, AppRole, McpAuthType, McpServer, McpServerInfo, McpTool, OAIRequestParams,
...
make_ui_endpoint!(ENDPOINT_MCPS_OAUTH_CONFIGS, "mcps/oauth-configs");
make_ui_endpoint!(ENDPOINT_MCPS_OAUTH_DISCOVER, "mcps/oauth/discover");
...
"#
    ...
    paths(
        ...
        // MCP OAuth endpoints
        create_oauth_config_handler,
        get_oauth_config_handler,
        list_oauth_configs_handler,
        oauth_login_handler,
        oauth_token_exchange_handler,
        oauth_discover_handler,
        // MCP OAuth token endpoints
