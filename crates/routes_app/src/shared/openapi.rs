use crate::{
  ...
  __path_api_models_test, __path_api_models_update, __path_apps_get_consent_context,
  __path_apps_list_user_access, __path_apps_revoke_access_request, __path_apps_submit_consent,
  __path_auth_callback, __path_auth_initiate, __path_auth_logout, __path_health_handler,
  __path_model_router_create, __path_model_router_destroy, __path_model_router_show,
  __path_model_router_update, __path_modelfiles_index, __path_models_copy, __path_models_create,
  __path_models_destroy, __path_models_index, __path_models_pull_archive,
  __path_models_pull_create, __path_models_pull_index, __path_models_pull_retry,
  ...
  __path_tokens_delete, __path_tokens_index, __path_tokens_update,
  ...
  __path_users_request_access, __path_users_request_status, AppInfo, DashboardUser,
  ListUsersParams, PaginatedLocalModelResponse, QueueStatusResponse, RedirectResponse,
  ResourceAccess, ResourceAccessInfo, TokenInfo, UserInfoEnvelope, UserResponse,
};
use crate::{
  AliasFilterParams, AppAccessSummary, AuthCallbackRequest, AuthInitiateRequest, ConsentAppInfo,
  ConsentContextResponse, ConsentDecision, ConsentPriorGrant, ConsentPriorGrantSource,
  ConsentScopeInfo, ListAppAccessResponse, LocalModelResponse, PaginationSortParams, PingResponse,
  SubmitConsentRequest, SubmitConsentResponse,
};
// MCP DTOs and handlers
use crate::{
  __path_apps_mcps_index, __path_apps_mcps_show, __path_mcp_auth_configs_create,
  ...
  __path_mcp_oauth_tokens_show, __path_mcp_proxy_handler, __path_mcp_servers_create,
  __path_mcp_servers_index, __path_mcp_servers_show, __path_mcp_servers_update, __path_mcps_create,
  __path_mcps_destroy, __path_mcps_index, __path_mcps_show, __path_mcps_update, CreateAuthConfig,
  DynamicRegisterRequest, DynamicRegisterResponse, ListMcpServersResponse, ListMcpsResponse,
  McpServerResponse, OAuthDiscoverAsRequest, OAuthDiscoverAsResponse, OAuthDiscoverMcpRequest,
...
use crate::{
  ...
  __path_tenants_create, __path_tenants_index, CreateTenantRequest, CreateTenantResponse,
...
"#
    ...
    paths(
        ...
        apps_get_consent_context,
        apps_submit_consent,
        apps_list_user_access,
        apps_revoke_access_request,
