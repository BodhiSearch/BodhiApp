  ...
  case 'linux':
    switch (arch) {
      ...
      case 'arm':
        if (isMusl()) {
          localFileExisted = existsSync(
            join(__dirname, 'bodhiapp-server-bindings.linux-arm-musleabihf.node')
          )
          try {
            if (localFileExisted) {
              nativeBinding = require('./bodhiapp-server-bindings.linux-arm-musleabihf.node')
            } else {
              nativeBinding = require('@bodhiapp/server-bindings-linux-arm-musleabihf')
            }
          } catch (e) {
            loadError = e
          }
          ...
          localFileExisted = existsSync(
            join(__dirname, 'bodhiapp-server-bindings.linux-arm-gnueabihf.node')
          )
          try {
            if (localFileExisted) {
      ...
      case 's390x':
        localFileExisted = existsSync(
          join(__dirname, 'bodhiapp-server-bindings.linux-s390x-gnu.node')
        )
        try {
          if (localFileExisted) {
