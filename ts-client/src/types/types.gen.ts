...
export type ConsentContextResponse = {
    ...
    prior_grant?: null | ConsentPriorGrant;
    /**
...
export type ConsentPriorGrantSource = 'explicit' | 'latest';
...
export type SubmitConsentRequest = {
    ...
    approved_role?: null | UserScope;
    approved?: null | ApprovedResources;
};
 ...
 */
export type SubmitConsentResponse = {
    /**
...
export type SubmitConsentData = {
    /**
     * Consent decision with the original query string
     */
    body: SubmitConsentRequest;
    path?: never;
    query?: never;
    url: '/bodhi/v1/apps/access-requests';
};

export type SubmitConsentErrors = {
    /**
     * Invalid request parameters
     */
    400: BodhiErrorResponse;
...
export type SubmitConsentError = SubmitConsentErrors[keyof SubmitConsentErrors];

export type SubmitConsentResponses = {
    /**
     * Deny or redirectable request error — no grant created
     */
    200: SubmitConsentResponse;
    /**
     * Grant created (approve)
     */
    201: SubmitConsentResponse;
};

export type SubmitConsentResponse2 = SubmitConsentResponses[keyof SubmitConsentResponses];

export type GetConsentContextData = {
    body?: never;
    path?: never;
    query?: {
        /**
        ...
        client_id?: string;
        /**
         * App redirect target; exact-matched against the app's registered URIs
         */
        redirect_uri?: string;
        /**
         * Must be 'code'
        ...
        /**
         * App-facing scope string (scope_user_*, scope_apps:*, passthrough tokens)
         */
        scope?: string;
        /**
         * Prior grant id for reauthorization
         */
        source_access_request_id?: string;
    };
    url: '/bodhi/v1/apps/access-requests/consent';
};

export type GetConsentContextErrors = {
    /**
     * Invalid request parameters
     */
    400: BodhiErrorResponse;
...
export type GetConsentContextError = GetConsentContextErrors[keyof GetConsentContextErrors];

export type GetConsentContextResponses = {
    /**
     * Consent context or a structured OAuth error
     */
    200: ConsentContextResponse;
};

export type GetConsentContextResponse = GetConsentContextResponses[keyof GetConsentContextResponses];
