...
# Optimal CUDA server arguments (no-webui for security, verbose for debugging)
ENV BODHI_LLAMACPP_ARGS="--verbose --no-webui --keep 24"
ENV BODHI_LLAMACPP_ARGS_CUDA="--n-gpu-layers 999 --split-mode layer --tensor-split auto"
