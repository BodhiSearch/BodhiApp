...
**Status:** Forward-looking roadmap (aspirational; verify against current state before acting).
...
- `../architecture/system-overview.md` - Current system architecture
- `../architecture/architectural-decisions.md` - Key architectural decisions and rationale
...
- **[System Overview](../architecture/system-overview.md)** - Current system architecture
- **[Architectural Decisions](../architecture/architectural-decisions.md)** - Key design decisions
- **[Crate Index](../../crates/CLAUDE.md)** - Backend crate map and shared Rust conventions
- **[Bodhi Frontend](../../crates/bodhi/src/CLAUDE.md)** - Vite + React + TanStack frontend architecture
