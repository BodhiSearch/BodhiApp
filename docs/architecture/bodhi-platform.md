...
**Architecture**: Multi-crate Rust backend with Vite + React frontend
...
- **Frontend integration patterns** - [`crates/bodhi/src/CLAUDE.md`](../../crates/bodhi/src/CLAUDE.md)
