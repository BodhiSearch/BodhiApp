...
- **Auth middleware internals** - [`crates/routes_app/src/middleware/CLAUDE.md`](../../crates/routes_app/src/middleware/CLAUDE.md)
- **Domain auth types (`ResourceRole`, `TokenScope`, `UserScope`)** - [`crates/services/CLAUDE.md`](../../crates/services/CLAUDE.md)
- **Frontend authentication patterns and backend-driven validation** - [`crates/bodhi/src/CLAUDE.md`](../../crates/bodhi/src/CLAUDE.md)
